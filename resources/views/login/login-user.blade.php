            ...
            <form class="g-3 needs-validation" novalidate>
                ...
                <div class="">
                  ...
                  <div class="contend-input">
                    ...
                    <input type="email" class="input-login form-control" id="validationCustom01" placeholder="email" required>
                  </div>
                ...
                <div class="">
                  ...
                  <div class="contend-input">
                    ...
                    <input type="password" class="input-login form-control" id="validationCustom02" placeholder="contraseña" required>
                  </div>
                  <div class="invalid-feedback">
