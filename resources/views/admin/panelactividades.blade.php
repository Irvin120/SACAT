...
@section('content')
                                        ...
                                        <div class="conten-modal modal-body">
                                            ...
                                            <div class="fecha">
                                                ...
                                                <div class="date-if">
                                                    ...
                                                    <input class="nameDate" type="date" name="fechaInicio" id="">
                                                </div>
    ...
    <!-- INICIO Revisar actividades -->
        ...
        <div class="contendButtonRevi">
            ...
            <button type="button" class="btn btn-primary buttonActivityOptions" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Revisar activid
                    <i class="icon fa-solid fa-calendar-plus fa-xl" style="color: #000000;"></i>
            </button>
                            ...
                            <!-- 1. Vista de Lista de actividades  -->
                                <div id="lista-actividades" class="contenedor-actividades activo">
                                    ...
                                    <!-- lista de actividades -->
                                        ...
                                        <i class="iconActividaxRevisar fa-solid fa-calendar fa-2xl" style="color: #000000;"></i>
                                        <button id="button-revisar" class="btnActividadxRevisar btn text-start">Actividad 1 - Resumen semana 1</button>
                                        </div>
                            ...
                            <!-- 2. Vista de detalles de la actividad (Lista de alumnos y cumplimiento diario por semana) -->
                                <div id="info-actividades" class="contenedor-actividades">
                                    ...
                                    <div class="d-grid gap-2 col-4 mx-auto">
                                        <button id="button-volver-lista" class="btnVolver btn btn-primary activo">volver</button>
                                    </div>
                                </div>
