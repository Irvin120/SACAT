    ...
    <div class="content">
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                ...
                <p class="mb-0"><span class="font-weight-bold">Inicio:</span> {{ $actividad->fechaInicio }} <br> <span class="font-weight-bold">Fin:</span> {{ $actividad->fechaFin }}</p>
            </div>
        </div>
                ...
                <form method="post" action="{{ route('registrarActividad') }}">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="{{ $dia }}">
                            {{ date('d/m/Y', strtotime($dia)) }} - {{ \Carbon\Carbon::parse($dia)->locale('es')->dayName }}
                        </label>
                        <input type="text" name="resumenes[]" placeholder="Resumen del día">
                    </div>
                @endforeach
