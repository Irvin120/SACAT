    ...
    <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3">
            ...
            <ul class="nav nav-pills">
              <li class="nav-item mx-3"><a href="#" class="nav-link" aria-current="page"> <i class="fa-solid fa-trash-can icon-header"></i></a></li>
              <li class="nav-item mx-3"><a href="#" class="nav-link"> <i class="fa-solid fa-pencil icon-header"></i> </a></li>
              <li class="nav-item mx-3"><a href="#" class="nav-link"> <i class="fa-solid fa-circle-plus icon-header"></i> </a></li>
