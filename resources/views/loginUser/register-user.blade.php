          ...
          <!--div class="mb-0 col-sm-0" id="form_login" class="info">
            ...
            <div class="col-sm-0" id="conten_form"-->
              ...
              <div class="mb-2 row">
                ...
                <div class="col-sm-7 entradas mx-auto" >
                  <img class="icon" src="img/usuario.jpg">
                  <input type="text" class="form-control" id="validationDefault01 inputName" placeholder="Nombre "  name= "nombreUsuario" value="" required>
              ...
              <div class="mb-2 row">
                ...
                <img class="icon" src="img/id.jpg">
                  ...
                  @if ($errors->has('matriculaUsuario'))
                    <div class="alert-container alert alert-danger">{{ $errors->first('matriculaUsuario', ':message') }}</div>
                  @endif
              ...
              <div class="mb-2 row">
                ...
                <div class="col-sm-7 entradas mx-auto" >
                <img class="icon" src="img/gmail.jpg">
                  ...
                  @if ($errors->has('correoUsuario'))
                    <div class="alert-container alert alert-danger">{{ $errors->first('correoUsuario', ':message') }}</div>
                  @endif
              </div>
              ...
              <div class="mb-2  row">
                ...
                <div class="col-sm-7 entradas mx-auto">
                <img class="icon"  src="img/contraseña.jpg">
              ...
              <!-- botones aceptar y cancelar -->
                <div class="ms-0 contenedor_ops d-flex justify-content-center">
