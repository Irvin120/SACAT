    ...
    <div class="content">
        ...
        <div class="coten-login mb-5">
            <div class="circulo-icon">
                <div class="circulo">
                    <i class="icon-login fa-solid fa-signature fa-6x" style="color: #282828;"></i>
                </div>
            </div>
            
            <p class="text-p">Cambiar nombre de usuario</p>
            ...
            <form class="g-3 needs-validation" novalidate>
                ...
                <div class="">
                  ...
                  <div class="contend-input">
                    <i class="icon-input fa-solid fa-user fa-xl" style="color: #000000;"></i>
                    <input type="password" class="input-login form-control" id="validationCustom02" placeholder="nuevo nombre de usuario" required>
                  </div>
                  <div class="invalid-feedback">
                    Por favor introduce tu nuevo nombre de usuario
                  </div>
                </div>
                ...
                <div class="repetir-contra">
                  ...
                  <div class="contend-input">
                    <i class="icon-input fa-solid fa-user fa-xl" style="color: #000000;"></i>
                    <input type="password" class="input-login form-control" id="validationCustom03" placeholder="repetir nombre de usuario" required>
                  </div>
                  <div class="invalid-feedback">
                    Por favor repite tu nuevo nombre de usuario
                  </div>
                </div>
